                ...
                <form action="{{ route('formbuilder::forms.update', $form) }}" method="POST" id="createFormForm" data-form-method="PUT">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="batas" class="col-form-label">Batas</label>

                                    <input id="batas" type="text" class="form-control{{ $errors->has('batas') ? ' is-invalid' : '' }}" name="batas" value="{{ old('batas') ?? $form->batas }}" required autofocus>
                            ...
                            <div class="col-md-3" @if($form->isPublic()) style="display: none;" id="allows_edit_DIV" @endif>
                                <div class="form-group">
