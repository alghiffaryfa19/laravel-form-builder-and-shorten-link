                ...
                <form action="{{ route('formbuilder::forms.store') }}" method="POST" id="createFormForm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="batas" class="col-form-label">Batas Waktu</label>

                                    <input id="batas" type="text" class="form-control{{ $errors->has('batas') ? ' is-invalid' : '' }}" name="batas" value="{{ old('batas') }}" required autofocus placeholder="2020-12-12 23:59:59">
